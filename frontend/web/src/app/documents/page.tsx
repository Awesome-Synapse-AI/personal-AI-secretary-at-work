  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col gap-1">
        ...
        <h1 className="text-2xl font-semibold">Upload and ingest documents</h1>
        <p className="text-slate-300">Files go to the shared collection and will be searchable from chat.</p>
      </header>
      ...
      <section className="glass-card grid gap-4 p-4 md:grid-cols-2">
        <form onSubmit={onUpload} className="space-y-3">
          ...
          <p className="text-xs text-slate-400">Uploads use owner={DEMO_USER_ID} and go to the default collection.</p>
        </form>
